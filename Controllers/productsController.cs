...
namespace hm6.Views.Home
{
    public class productsController : Controller
    {
        ...
        //}
        public ActionResult Index(string prodname,int ? i)
        {
            var products = db.products.ToList();
            return View(db.products.Where(x => x.product_name.StartsWith(prodname) || prodname == null).ToList().ToPagedList(i ?? 1, 11));
        }
